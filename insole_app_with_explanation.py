...
# 説明文（簡略版）
arch_explains = {
    "Flat": "偏平足傾向：土踏まずが低く衝撃吸収が弱いため、疲れやすさや足・膝・腰への負担が増します。サポート力のあるインソールでの補正が効果的です。",
    "High": "ハイアーチ傾向：土踏まずが高く足裏の接地が少ないため、衝撃が集中しやすく痛みやバランス不良の原因になります。クッション性が重要です。",
    "Normal": "正常：バランスの取れた足型で衝撃吸収に優れていますが、加齢や姿勢の乱れで崩れることも。定期的なチェックと予防が大切です。",
    "外反母趾": "外反母趾：親指が外側に曲がる症状で、痛みや変形を伴いやすく靴選びが重要です。初期対応やインソールでの補正が進行防止につながります。"
}
